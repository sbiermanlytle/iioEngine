...
function TurretDefender(io){
    ...
    minAttackDelay = 200;
    attackDelay = 0;
    var enemyShipImg = iio.loadImage('img/turrets/enemyShip.png');
    function createEnemyShip(x,y){ 
        var meteor = io.addToGroup('enemies'
            ,new iio.SimpleRect(x,y))
                .enableKinematics()
                .setBound('left', -200)
                .setBound('right', io.canvas.width+200)
    ...
    //Player Turret
    var turret;
    var turretBaseImg = iio.loadImage('img/turrets/turretStand.png', function(){
        io.addToGroup('turret stand', new iio.SimpleRect(io.canvas.width/2,io.canvas.height)
            .createWithImage(turretBaseImg), -10);
    });
    var turretImg = iio.loadImage('img/turrets/turretTop.png', function(){
    ...
    //Lasers
    var laserImg = iio.loadImage('img/turrets/laserRed.png');
    fireLaser = function(){
    ...
    var laserFlashImg = iio.loadImage('img/turrets/laserRedShot.png');
    ...
    //Score
    var score = 0;
    var text = io.addToGroup('GUI', new iio.Text(score,30,50)
