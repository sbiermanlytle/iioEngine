...
!function (jQuery) {
  ...
  * ====================== */
  ...
  Alert.prototype.close = function (e) {
    ...
    $parent.trigger(e = jQuery.Event('close'))
    ...
    jQuery.support.transition && $parent.hasClass('fade') ?
      $parent.on(jQuery.support.transition.end, removeElement) :
      removeElement()
  }
...
!function (jQuery) {
  ...
  * ========================= */
  ...
  , to: function (pos) {
      ...
      return this.slide(pos > activeIndex ? 'next' : 'prev', jQuery(this.$items[pos]))
    }
  ...
  , slide: function (type, next) {
      ...
      if (this.$indicators.length) {
        ...
        this.$element.one('slid', function () {
          var $nextIndicator = jQuery(that.$indicators.children()[that.getActiveIndex()])
  ...
  * ================= */
  ...
  jQuery(document).on('click.carousel.data-api', '[data-slide], [data-slide-to]', function (e) {
    var $this = jQuery(this), href
      , $target = jQuery($this.attr('data-target') || (href = $this.attr('href')) && href.replace(/.*(?=#[^\s]+jQuery)/, '')) //strip for ie7
  ...
  jQuery.fn.collapse = function (option) {
    return this.each(function () {
      var $this = jQuery(this)
        ...
        , options = jQuery.extend({}, jQuery.fn.collapse.defaults, $this.data(), typeof option == 'object' && option)
  ...
  jQuery(document).on('click.collapse.data-api', '[data-toggle=collapse]', function (e) {
    var $this = jQuery(this), href
      , target = $this.attr('data-target')
        || e.preventDefault()
        || (href = $this.attr('href')) && href.replace(/.*(?=#[^\s]+jQuery)/, '') //strip for ie7
      , option = jQuery(target).data('collapse') ? 'toggle' : $this.data()
    $this[jQuery(target).hasClass('in') ? 'addClass' : 'removeClass']('collapsed')
...
!function (jQuery) {
  ...
  * ========================= */
  ...
  , keydown: function (e) {
      ...
      $items = jQuery('[role=menu] li:not(.divider):visible a', $parent)
...
!function (jQuery) {
  ...
  * ============== */
  ...
  jQuery(document).on('click.modal.data-api', '[data-toggle="modal"]', function (e) {
    var $this = jQuery(this)
      , href = $this.attr('href')
      , $target = jQuery($this.attr('data-target') || (href && href.replace(/.*(?=#[^\s]+jQuery)/, ''))) //strip for ie7
...
!function (jQuery) {
  ...
  * =============================== */
  ...
  , getOptions: function (options) {
      options = jQuery.extend({}, jQuery.fn[this.type].defaults, this.$element.data(), options)
    ...
    , refresh: function () {
        ...
        $targets = this.$body
          ...
          .map(function () {
            ...
            return ( $href
              && $href.length
              && [[ $href.position().top + (!jQuery.isWindow(self.$scrollElement.get(0)) && self.$scrollElement.scrollTop()), href ]] ) || null
          })
...
!function (jQuery) {
  ...
  * ==================== */
  ...
  , activate: function ( element, container, callback) {
      ...
      transition ?
        $active.one(jQuery.support.transition.end, next) :
        next()
