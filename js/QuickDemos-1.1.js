...
AnimsDemo = function(io){
  ...
  var fly = new iio.ioRect(io.canvas.width-60, 60, 69, 32)
  ...
  //create the rectangle with the dimensions of the first image
  var slime = new iio.ioRect(io.canvas.width-50, io.canvas.height-24)
...
ImageDemo = function(io){
  ...
  var smily = new iio.ioRect(io.canvas.center.x+50 //xpos
...
LineDemo = function(io){
  ...
  //load ioLine (make it directly accessable)
  ...
  //color: red
  //lineWidth: 1
  io.addObj(new ioLine(40,120,160,160)
    .setStrokeStyle('red',1));

  //create another red line
  io.addObj(new ioLine(40,100,160,140)
  ...
  io.addObj(new ioLine(40,80,160,120)
  	.setStrokeStyle(gradient,4));

  //create a blue line
  io.addObj(new ioLine(40,60,160,100)
  	.setStrokeStyle('blue',2));

  //create a green line
  io.addObj(new ioLine(40,40,160,80)
...
CirclesDemo = function(io){
  ...
  //load ioCircle (make it directly accessable)
...
PolyDemo = function(io){
  ...
  //load ioPoly (make it directly accessable)
...
TextDemo = function(io){
  ...
  //load ioText (make it directly accessable)
  var ioText = iio.ioText;

  //blue text
  io.addObj(new ioText('Text',70,65)
    .setFont('50px Consolas')
    .setTextAlign('center')
    .setFillStyle('#00baff'));

  //stroked text
  io.addObj(new ioText('Text',70,115)
  	.setFont('50px Arial')
  	.setTextAlign('center')
  	.setStrokeStyle('#a3da58'));

  //red text
  io.addObj(new ioText('Text',70,165)
  ...
  //gradient text
  io.addObj(new ioText('Text',140,100)
...
function CollisionsDemo(io) {
  //load ioRect to a local reference
  var ioRect = iio.ioRect;
  ...
  function createMeteor(){
    io.addToGroup('meteors', new ioRect(iio.getRandomInt(30,io.canvas.width-30)
  ...
  function createLasor(){
        io.addToGroup('lasors', new ioRect(iio.getRandomInt(30,io.canvas.width-30)
                                          ,io.canvas.height+60)
       .enableKinematics()
       .setBound('top', -100)
  ...
  io.setCollisionCallback('lasors', 'meteors', function(lasor, meteor){
      ...
      ,new ioRect((lasor.pos.x+meteor.pos.x)/2
