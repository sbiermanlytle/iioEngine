PlatformerApp = function(io){
  io.setBGImage('img/mariobg.png');
  var groundY=49;
  ...
  var marioSprites = new iio.SpriteMap('img/mario.png',16,32,function(){

    //code calls when image has loaded
    mario = new iio.Rect(30, io.canvas.height-groundY)
