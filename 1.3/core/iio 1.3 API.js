...
// app Functions
//
	app.background( bg, repeatX, repeatY )
		sets the base canvas background to a color, image or pattern
		depending upon the given parameter

		-to set a color, pass a String in the standard CSS format:
			'rgb(255,255,255)'
			'rgba(255,255,255,0.1)'
			'#00baff'
			'white'

		-to set an image or a pattern, pass an image path as a String
		 or a preloaded image object
		'repeatX' and 'repeatY' are optional Boolean parameters
