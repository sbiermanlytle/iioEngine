...
(function(){
   ...
   iio.loop=function(fps,caller,fn){
      if(iio.isNumber(fps)||typeof window.requestAnimationFrame=='undefined'||!fps.rqAnimFrame){
         if(typeof(fps.rqAnimFrame)!='undefined'){ fn=caller; caller=fps; fps=60 }
         function loop(){
            var n = new Date().getTime();
            var correctedFPS = Math.floor(Math.max(0, 1000/fps - (n - (caller.last||0))));
            caller.last = n + correctedFPS;
            if(caller._update) caller._update(correctedFPS);
            if(caller.app) caller.app.draw();
         ...
         caller=fps;
         function animloop(){ 
            if(caller._update) caller._update();
            if(caller.app) caller.app.draw();
   ...
   iio.runiioConst=function(o,c){
      ...
      if(i>-1&&ii==-1){
         o.width=o.parent.eval(c.substring(0,i));
   ...
   init=function(){
      ...
      this.loop=function(fps,fn){
         if(this.looping){
            if(window.cancelAnimationFrame&&this.rqAnimFrame)
         ...
         if(typeof fn=='undefined'){
            if(typeof fps=='undefined')
               this.loopID = iio.loop(this,this._update);
      ...
      this.playAnim=function(fps,t,r,fn,s){
         ...
         if(fps>0) this.loopID = this.loop(fps,forward);
         else if(fps<0) this.loopID = this.loop(fps*-1,backward);
         else this.app.draw();
         return this.loopID;
      }
   ...
   set=function(s){
      ...
      if(this.anims){
         this.animKey=0;
         this.animFrame=0;
         this.width=this.anims[this.animKey].frames[this.animFrame].w;
         this.height=this.anims[this.animKey].frames[this.animFrame].h;
      }
      if(this.bezier)
   ...
   add=function(o,ii,s){
      ...
      } else o=this.add(new iio.Obj(o,ii,s,this));
      this.app.draw();
      return o;
   }
   rmv=function(o){
      ...
      if(this.collisions) for(var i=0;i<this.collisions.length;i++){
         ...
         if(this.collisions[i][0] instanceof Array)
   ...
   App.prototype.App=function(view,app,s){
      ...
      this.app=this;
      iio.apps.push(this);
      if(iio.isString(app)) this.runScript=iio.run(app,this);
   ...
   SpriteMap.prototype.sprite=function(w,h,a,y,n){
      var s={};
      if(iio.isString(w)){
         s.tag=w; w=h; h=a; a=y; y=n;
      } 
   ...
   Obj.prototype.Obj = function(p,s,ss,pp){
      ...
      this._update=function(dt){
         ...
         if(this.bounds&&!this.simple){
            ...
            if(this.bounds.left) remove = iio.lowerBoundReached(this.bounds.left,this.pos.y,this);
            if(this.bounds.top) remove = iio.lowerBoundReached(this.bounds.top,this.pos.x,this);
   ...
   iio.initLine=function(o){
      ...
      o.updateProps=function(v){
         iio.V.add(this.endPos,v);
         iio.V.add(this.center,v);
      }
   }
   ...
   iio.initText=function(o){
      ...
      if(o.showCursor){
         iio.loop(2,o.cursor,function(id,o){
            o.hidden=!o.hidden;
            o.app.draw();
         })
