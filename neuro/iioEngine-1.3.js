...
(function(){
   ...
   iio.drawGrid = function(obj){
      obj.ctx.translate(-Math.floor(obj.width/2),-Math.floor(obj.height/2));
      for (var r=1; r<obj.R; r++)
         iio.drawLine(obj.ctx,0,r*obj.res.y,obj.C*obj.res.x,r*obj.res.y);
      for (var c=1; c<obj.C; c++)
         iio.drawLine(obj.ctx,c*obj.res.x,0,c*obj.res.x,obj.R*obj.res.y);
      obj.ctx.translate(Math.floor(obj.width/2),Math.floor(obj.height/2));
   }
