...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
      ...
      <div class="docs-top">
        ...
        <h1 style="margin-bottom:30px;">AppManager</h1>
        <p>The AppManager is a class that assists with the management of application assets. These assets can be canvas elements, iio Objects, or a Box2D world.</p>
        <p>The main iio <a href="iio-functions.php#start">start</a> functions are designed to provide an application script with a new instantiation of an AppManager:</p>
        <pre class="prettyprint linenums:1">MyApplication = function(AppManager){
  
  //AppManager's properties are ready to go
  alert(AppManager.canvas.width);

}; iio.start(MyApplication, 'canvasId');</pre>
      <p>Note that you can name the AppManager parameter anything you want. I always shorten it to <span class="kwd">io</span> for convenience.</p>
      <p>All code samples on this documentation page are assumed to be inside a main application function where a reference to the AppManager exists.</p>
</div>
      <div class="docs-middle">
         <a class="anchor" name="properties">&nbsp;</a> 
        <h2>Properties</h2>
         <p>Your AppManager has references to your application's canvas elements and to those canvas' 2d contexts.</p>
...
var context = io.ctxs[1];</pre>
        ...
        <div class="docs-inner">
         ...
         <h3 style="margin-left:136px"class="func"><span style="margin-left:-136px">setFramerate( <?php echo $NumberLink ?> fps, <a href="Obj.php">Obj</a> obj, <span class="red">Context</span> ctx, <?php echo $FunctionLink ?> callback )</h3>
...
io.setFramerate(60, new iio.Rect(0,0,60)
         ...
         <h3 class="func">pauseFramerate( <?php echo $BoolLink?> pause, <a href="Obj.php">Obj</a> obj obj )</h3>
...
io.pauseFramerate();</pre>
        ...
        <div class="docs-inner">
         ...
         <h3 class="func">cancelFramerate( <a href="Obj.php">Obj</a> obj )</h3>
          <h5>:: Returns <a href="iio-basics.php#this">this</a> || obj</h5>
...
io.cancelFramerate( obj );</pre>
        ...
        <div class="docs-inner">
          ...
          <h3>setAnimFPS( <?php echo $NumberLink ?> fps, <a href="Obj.php">Obj</a> obj, <?php echo $NumberLink ?> canvasId )</h3>
...
io.setAnimFPS(24, myAnimObject);</pre>
        ...
        <p>These functions give you control over your application's canvas elements. Most applications are best off using just one canvas, but an <a href="AppManager.php#addCanvas">addCanvas</a> function exists for cases in which an application has object layers that do not have to be redrawn on every update.</p>
        <div class="docs-inner">
...
io.addCanvas(0, 400, 600, 'myElementId', ['class1', 'class2']);</pre>
          ...
          <p>- returns the event's position as an <a href="Vec.php">Vec</a> relative to the specified canvas's origin (its top-left corner). If no <span class="kwd">c</span> is specified, the base canvas is used.</p>
...
io.canvas.addEventListener('mousedown', function(event){
    alert(io.getEventPosition(event).toString());
        ...
        <div class="docs-inner">
          ...
          <h5>:: Returns <a href="AppManager.php#overview">AppManager</a></h5>
          <p>- Sets the css <a target="_new" href="http://www.w3schools.com/cssref/pr_background-color.asp">background-color</a> property to the given color. This function will act on the base canvas unless a different <a href="AppManager.php#cnvs">c</a> is specified.</p>
...
io.setBGColor('rgba(0,0,0,.5)',2);</pre>
        ...
        <div class="docs-inner">
          ...
          <p>- Sets the css <a href="http://www.w3schools.com/cssref/pr_background-image.asp">background image</a> of this canvas to the given image. Horizontal and vertical image repetition are active by default. This function will act on the base canvas unless a different <a href="AppManager.php#cnvs">c</a> is specified.</p>
          <pre class="prettyprint linenums:1">
...
io.setBGPattern('myBGPattern.png', io.addCanvas());</pre>
        ...
        <div class="docs-inner">
          ...
          <h5>:: Returns <a href="AppManager.php#overview">AppManager</a></h5>
          <p>- Sets the css <a href="http://www.w3schools.com/cssref/pr_background-image.asp">background image</a> of this canvas to the given image and disables vertical and horizontal repeats. This function will act on the base canvas unless a different <a href="AppManager.php#cnvs">c</a> is specified.</p>
          <pre class="prettyprint linenums:1">
//set a background image
...
io.setBGImage('myBG.jpg', io.addCanvas());</pre>
        ...
        <p>The AppManager can help you manage objects by automatically calling their update and draw functions when you need to re-render the screen.</p>
        ...
        <div class="docs-inner">
          ...
          <h3>addObj( <a href="Obj.php">Obj</a> obj, <?php echo $NumberLink ?> c )</h3>
          <h5>:: Returns <a href="Obj.php">Obj</a> - the object you gave it</h5>
...
io.addObj(new iio.Rect(0,0,60)
    .setFillStyle('blue'), 1);
        ...
        <div class="docs-inner">
          ...
          <h3>rmvObj( <a href="Obj.php">Obj</a> obj, <?php echo $NumberLink ?> c )</h3>
...
io.addGroup('boxes', 10);</pre>
        ...
        <div class="docs-inner">
          ...
          <h3>addToGroup( <?php echo $StringLink ?> tag, <a href="Obj.php">Obj</a> obj, <?php echo $NumberLink ?> zIndex, <?php echo $NumberLink ?> c )</h3>
...
io.addToGroup('boxes', new iio.Rect(0,0,60), 10);</pre>
        </div>
        <div class="docs-inner">
          <a class="inner-anchor" name="rmvFromGroup">&nbsp;</a> 
          <h3>rmvFromGroup( <?php echo $StringLink ?> tag, <a href="Obj.php">Obj</a> obj, <?php echo $NumberLink ?> c )</h3>
          <h3 class="func">rmvFromGroup( <?php echo $StringLink ?> tag, <?php echo $NumberLink ?> c )</h3>
          <h5>:: Returns <?php echo $BoolLink ?></h5>
          <p><span class="red">NOTE:</span> this is an updated function available in the 1.2.2+ version of iio (download on Github). The previous verions of iio have a <span class="kwd">rmvFromGroup(obj, tag, c)</span> function.</p>
          ...
          <p>- if no <span class="kwd">obj</span> is specified, all objects will be removed from the group.</p>
          <pre class="prettyprint linenums:1">
