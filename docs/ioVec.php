...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
      ...
      <div class="docs-top">
        ...
        <p><span class="red">Vector</span> is not a class, it it used to represent any class that has <span class="kwd">x</span>,<span class="kwd">y</span> properties of type <?php echo $NumberLink ?>. <span class="kwd">b2Vec2</span> in the Box2D framework is one of these vector classes - it can be used in place of <a href="">ioVec</a> whenever the <span class="red">Vector</span> type is specified.</p>
...
//use ioVec without local declaration
var v = new iio.ioVec(10,10);
var v2 = iio.ioVec.add(v,20,20);

//local declaration
var ioVec = iio.ioVec;

//use ioVec with local declaration
var v = new ioVec(10,10);
var v2 = ioVec.add(v,20,20);</pre>
      </div>
      <div class="docs-middle">
        <a class="anchor" name="constructors">&nbsp;</a> 
        <h2>Constructors</h2>
        <p>These functions are used to instantiate new instances of the <a href="">ioVec</a> class. Constructor functions must be preceded by the <span class="kwd">new</span> keyword.</p>
        <div class="docs-inner">
        <a class="anchor inner-anchor" name="ioVec1">&nbsp;</a> 
          <h3>ioVec( <?php echo $NumberLink ?> x, <?php echo $NumberLink ?> y )</h3>
          <p>- Creates the vector ( x, y ). Undefined parameters are set to 0.</p>
          <pre class="prettyprint linenums:1">
var v = new ioVec(1,1);</pre>
        </div>
        <div class="docs-inner">
        <a class="anchor inner-anchor" name="ioVec2">&nbsp;</a>
          <h3>ioVec( <a class="red" href="ioVec.php#vector">Vector</a> v )</h3>
...
//y will be set to 3</pre>
      ...
      <div class="docs-middle">
        <a class="anchor" name="member-functions">&nbsp;</a> 
        <h2>Member Functions</h2>
        <p>These functions are available to all <a href="">ioVec</a> objects. Most are mutator functions (they alter the properties of the object that calls them) and return <a href="../documentation.php#this">this</a>, to allow for cascading function calls.</p>
        <div class="docs-inner">
        <a class="anchor inner-anchor" name="clone">&nbsp;</a> 
        <h3>.clone()</h3>
        <h5>:: Returns <a href="">ioVec</a></h5>
...
var mag = v.length(); </pre>
        ...
        <h3>.normalize()</h3>
        <h5>:: Returns <a href="../documentation.php#this">this</a></h5>
...
v.normalize();</pre>
        ...
        <h3>.set( <a class="red" href="ioVec.php#vector">Vector</a> v )</h3>
...
//v will have the coordinates (5,5)</pre>
        ...
        <h3>.dot( <a class="red" href="ioVec.php#vector">Vector</a> v )</h3>
...
var dP = v2.dot(10,10);</pre>
        ...
        <h3>.distance( <a class="red" href="ioVec.php#vector">Vector</a> v )</h3>
...
var dist = v1.distance(10,10)</pre>
        ...
        <h3>.lerp( <a class="red" href="ioVec.php#vector">Vector</a> v, <?php echo $NumberLink ?> weight )</h3>
...
v1.lerp(10,10,0.5)</pre>
      ...
      <div class="docs-middle">
        ...
        <p>These functions can be called without an instantiated <a href="">ioVec</a> object. They are useful when creating new vectors with altered properties of existing ones. None of these functions alter the properties of the given vectors.</p>
        <div class="docs-inner">
         <a class="anchor inner-anchor" name="static-toString">&nbsp;</a> 
        <h3>.toString( <a class="red" href="ioVec.php#vector">Vector</a> v )</h3>
...
var v = new ioVec(10,10);
//show the value of v
alert(ioVec.toString(v))</pre>
        </div>
        <div class="docs-inner">
         <a class="anchor inner-anchor" name="static-length">&nbsp;</a> 
        <h3>.length( <a class="red" href="ioVec.php#vector">Vector</a> v )</h3>
...
var v = new ioVec(10,10);
//get the length of v
var mag = ioVec.length(v);
//or
var mag = ioVec.length(10,10);</pre>
        </div>
         <div class="docs-inner">
          <a class="anchor inner-anchor" name="static-normalize">&nbsp;</a> 
        <h3>.normalize( <a class="red" href="ioVec.php#vector">Vector</a> v )</h3>
...
var var v2 = ioVec.normalize(v);
//or create a normalized vector with int parameters
var var v3 = ioVec.normalize(10,10);</pre>
        </div>
        <div class="docs-inner">
          <a class="anchor inner-anchor" name="static-add">&nbsp;</a> 
        <h3>.add( <a class="red" href="ioVec.php#vector">Vector</a>: v1, v2 )</h3>
          <h3 class="func">.add( <a class="red" href="ioVec.php#vector">Vector</a> v1, <?php echo $NumberLink ?>: x2, y2 )</h3>
          <h3 class="func">.add( <?php echo $NumberLink ?>: x1, y1, <a class="red" href="ioVec.php#vector">Vector</a> v2 )</h3>
...
var v1 = new ioVec(1,1);
var v2 = new ioVec(2,3);
//get a vector equal to the sum of v1 and v2
var v3 = ioVec.add(v1,v2);
//or
var v3 = ioVec.add(v1,2,3);
//or
var v3 = ioVec.add(1,1,v2);
//or
var v3 = ioVec.add(1,1,2,3);
//v3 will have the coordinates (3, 4)</pre>
        </div>
        <div class="docs-inner">
          <a class="anchor inner-anchor" name="static-sub">&nbsp;</a> 
        <h3>.sub( <a class="red" href="ioVec.php#vector">Vector</a>: v1, v2 )</h3>
          <h3 class="func">.sub( <a class="red" href="ioVec.php#vector">Vector</a> v1, <?php echo $NumberLink ?>: x2, y2 )</h3>
          <h3 class="func">.sub( <?php echo $NumberLink ?>: x1, y1, <a class="red" href="ioVec.php#vector">Vector</a> v2 )</h3>
...
var v1 = new ioVec(10,10);
var v2 = new ioVec(2,3);
//get a vector equal to the sum of v1-v2
var v3 = ioVec.sub(v1,v2);
//or
var v3 = ioVec.sub(v1,2,3);
//or
var v3 = ioVec.sub(10,10,v2);
//or
var v3 = ioVec.sub(10,10,2,3);
//v3 will have the coordinates (8,7)</pre>
        </div>
        <div class="docs-inner">
          <a class="anchor inner-anchor" name="static-mult">&nbsp;</a> 
          <h3>.mult( <a class="red" href="ioVec.php#vector">Vector</a> v1, <?php echo $NumberLink ?> factor )</h3>
...
var v = new ioVec(1,1);
//get vector v*5
var v2 = ioVec.mult(v,5);
//or
var v2 = ioVec.mult(1,1,5);
//v will have the coordinates (5, 5)</pre>
        </div>
        <div class="docs-inner">
          <a class="anchor inner-anchor" name="static-div">&nbsp;</a> 
          <h3>.div( <a class="red" href="ioVec.php#vector">Vector</a> v1, <?php echo $NumberLink ?> divisor )</h3>
...
var v = new ioVec(10,10);
//get vector v/2
var v2 = ioVec.div(v,2);
//or
var v2 = ioVec.div(10,10,2);
//v will have the coordinates (5,5)</pre>
        </div>
        <div class="docs-inner">
          <a class="anchor inner-anchor" name="static-dot">&nbsp;</a> 
        <h3>.dot( <a class="red" href="ioVec.php#vector">Vector</a>: v1, v2 )</h3>
          <h3 class="func">.dot( <a class="red" href="ioVec.php#vector">Vector</a> v1, <?php echo $NumberLink ?>: x2, y2 )</h3>
          <h3 class="func">.dot( <?php echo $NumberLink ?>: x1, y1, <a class="red" href="ioVec.php#vector">Vector</a> v2 )</h3>
...
var dP = ioVec.dot(v1,v2);
//or
var v3 = ioVec.dot(v1,2,2);
//or
var v3 = ioVec.dot(10,10,v2);
//or
var v3 = ioVec.dot(10,10,2,2);</pre>
        </div>
        <div class="docs-inner">
          <a class="anchor inner-anchor" name="static-distance">&nbsp;</a> 
        <h3>.distance( <a class="red" href="ioVec.php#vector">Vector</a>: v1, v2 )</h3>
          <h3 class="func">.distance( <a class="red" href="ioVec.php#vector">Vector</a> v1, <?php echo $NumberLink ?>: x2, y2 )</h3>
          <h3 class="func">.distance( <?php echo $NumberLink ?>: x1, y1, <a class="red" href="ioVec.php#vector">Vector</a> v2 )</h3>
...
var v2 = new ioVec(10,10);
//get the distance between v1 and v2
var dist = ioVec.distance(v1,v2);
//or
var dist = ioVec.distance(v1,10,10);
//or
var dist = ioVec.distance(1,1,v2);
//or
var dist = ioVec.distance(1,1,10,10);</pre>
        </div>
        <div class="docs-inner">
          <a class="anchor inner-anchor" name="static-lerp">&nbsp;</a> 
        <h3>.lerp( <a class="red" href="ioVec.php#vector">Vector</a>: v1, v2, <?php echo $NumberLink ?> weight )</h3>
          <h3 class="func">.lerp( <a class="red" href="ioVec.php#vector">Vector</a> v1, <?php echo $NumberLink ?>: x2, y2, weight )</h3>
          <h3 class="func">.lerp( <?php echo $NumberLink ?>: x1, y1, <a class="red" href="ioVec.php#vector">Vector</a> v2, <?php echo $NumberLink ?> weight )</h3>
...
var v3 = ioVec.lerp(v1,v2,0.5);
//or
var v3 = ioVec.lerp(v1,10,10,0.5);
//or
var v3 = ioVec.lerp(1,1,v2,0.5);
//or
var v3 = ioVec.lerp(1,1,10,10,0.5);</pre>
        </div>
      </div>
